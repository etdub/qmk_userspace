...
#define ESC_MED LT(LAYER_MEDIA, KC_ESC) // unused
...
#define LAYOUT_LAYER_BASE                                                                     \
       ...
       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, \
                      ESC_SYM, BSP_NUM, DEL_NAV, ENT_NAV, SPC_SYM
...
#define LAYOUT_LAYER_NAVIGATION                                                               \
    ...
    KC_PGUP, KC_HOME,  KC_END, KC_PGDN,  KC_TAB, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX, \
    _______________DEAD_HALF_ROW_______________, _______________DEAD_HALF_ROW_______________, \
...
#define LAYOUT_LAYER_NUMERAL                                                                  \
    ...
    _______________DEAD_HALF_ROW_______________, KC_SCLN,    KC_4,    KC_5,    KC_6,  KC_EQL, \
    _______________DEAD_HALF_ROW_______________,  KC_GRV,    KC_1,    KC_2,    KC_3, KC_BSLS, \
                      XXXXXXX, _______, XXXXXXX,    XXXXXXX,  KC_0
...
#define LAYOUT_LAYER_SYMBOLS                                                                  \
    KC_QUOT, KC_LABK, KC_RABK, KC_DQUO,  KC_DOT, KC_AMPR,  KC_GRV, KC_LBRC, KC_RBRC, KC_PERC, \
    KC_EXLM, KC_MINS, KC_PLUS,  KC_EQL, KC_HASH, KC_PIPE, KC_COLN, KC_LPRN, KC_RPRN, KC_QUES, \
    KC_UNDS, KC_SLSH, KC_ASTR, KC_BSLS, KC_CIRC, KC_TILD,  KC_DLR, KC_LCBR, KC_RCBR,   KC_AT,\
